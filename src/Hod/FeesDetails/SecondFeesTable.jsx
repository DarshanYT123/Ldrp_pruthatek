...
//   ]
  ...
  return (
    <>
      <div className="rounded-[6px]   py-5 overflow-y-scroll  bg-[#F9FAFA]  ">
        <div className="py-5 px-5">
          <h1 className="font-Raleway text-center text-[#47A5E4] text-[20px] font-bold leading-[23.48px] tracking-[5.5%]">
          ...
          return(
            ...
            <div className=""key={index}>
              ...
              <div className="  border-[5px] border-[#FFFFFF] rounded-[11px] bg-gradient-to-r from-[#47A5E4] to-[#16376E]  w-[197px] h-[197px] ">
                  ...
                  <div className="flex justify-between items-center relative top-14 px-2 ">
