...
class StudentHistory extends Component {
  ...
  continue = e => {
    e.preventDefault(); 
    const isStudentNameValid = this.props.validateStudentName();
    const isemailIdValid = this.props.validateEmailid();
    const isPincode =this.props.validatePincode();
    const isAdrress = this.props.validateAddress();
    const isStudentno=this.props.validateStudentno();
    const isFatherno = this.props.validateFatherno();
    const isMotherno = this.props.validateMotherno();
    const isfather = this.props.validateFathername();
    const ismother=this.props.validateMothername();



   
    if (isStudentNameValid && isemailIdValid && isPincode &&  isAdrress && isStudentno 
      && isFatherno && isMotherno && isfather && ismother
      ) {
      this.props.nextStep();
    }
  }
...
<div className="overflow-hidden  max-h-[520px]   overflow-y-scroll flex justify-center ">
      <div className="w-screen py-[1.8rem] ">
          ...
          <form >
            <div className="flex  flex-row px-10 justify-between items-center  py-5">
              <div className="flex flex-row">
                ...
                <input
                  ...
                  id="studentname"
                  name="studentname"
                  onChange={handleChange('studentname')} onBlur={validateStudentName}
                  // value={studentname}
                ...
                <p className='error p-2'>{isErrorStudentName &&   errorMessageStudentName}</p>
              </div>
              <div className="flex flex-row">
                <label
                  for="date"
            ...
            <div className="flex justify-between items-center px-10 flex-row py-5">
              <div className="flex flex-row">
                ...
                <input
                  ...
                  id="emailId"
                  name="emailId"
                  onChange={handleChange('emailId')} onBlur={validateEmailid}
                  //value={emailId}
                  // onChange={handleInputChange}
                 // onBlur={validateOne}
                  ...
                  tabindex="3"
                />
                <p className='error p-2'>{isErrorEmailid &&   errorMessageEmailid}</p>
              </div>
              <div className="flex flex-row">
                <label
                  for="dob"
            ...
            <div class="px-10">
              ...
              <textarea
                ...
                id="address"
                name="address"
                onChange={handleChange('address')} onBlur={validateAddress}
                // value={address}
                  // onChange={handleInputChange}
                  // onBlur={validateOne}
                ...
                tabIndex="9"
              />
               <p className='error p-2'>{isErrorAddress &&   errorMessageAddress}</p>
            </div>
            ...
            <div className="flex justify-between items-center px-10 lex-row py-5">
              ...
              <div className="flex flex-row">
                ...
                <input
                  ...
                  id="pincode"
                  name="pincode"
                  onChange={handleChange('pincode')} onBlur={validatePincode}
                  // value={pincode}
                  // onChange={handleInputChange}
                  //onBlur={validateOne}
                  ...
                  tabindex="12"
                />
                 <p className='error p-2'>{isErrorPincode &&   errorMessagePincode}</p>
              </div>
            </div>
              ...
              <div className="flex flex-row">
                <div class="mb-6">
                  ...
                  <input
                    ...
                    id="studentno"
                    name="studentno"
                    onChange={handleChange('studentno')} onBlur={validateStudentno}
                    // value={studentno}
                  // onChange={handleInputChange}
                  // onBlur={validateOne}
                   ...
                   // required
                    tabIndex="18"
                  />
                      <p className='error p-2'>{isErrorStudentno &&   errorMessageStudentno}</p>
                </div>
              </div>
              ...
              <div className="flex flex-row">
                <div class="mb-6">
                  ...
                  <input
                    ...
                    id="fatherno"
                    name="fatherno"
                    onChange={handleChange('fatherno')} onBlur={validateFatherno}
                    // value={fatherno}
                  // onChange={handleInputChange}
                  // onBlur={validateOne}
                    className="hover:border-[2px] hover:border-[#159BD6] ml-[5px]  w-[280px] h-[40px] rounded-[5px] border border-[#CBCBCB] bg-[#FFFFFF] font-inter  p-3 font-medium text-[16px] leading-[19.36px] tracking-[2%] focus:outline-none"
                    ...
                    tabIndex="19"
                  />
                  <p className='error p-2'>{isErrorFatherno &&   errorMessageFatherno}</p>
                </div>
              </div>
              ...
              <div className="flex flex-row">
                <div class="mb-6">
                  ...
                  <input
                    ...
                    id=" motherno"
                    name="motherno"
                    onChange={handleChange('motherno')} onBlur={validateMotherno}
                    // value={motherno}
                    // onChange={handleInputChange}
                    // onBlur={validateOne}
                    className="hover:border-[2px] hover:border-[#159BD6] ml-[5px] w-[280px] h-[40px] rounded-[5px] border border-[#CBCBCB] bg-[#FFFFFF] font-inter p-3 font-medium text-[16px] leading-[19.36px] tracking-[2%] focus:outline-none"
                   ...
                   // required
                    tabIndex="20"
                  />
                  <p className='error p-2'>{isErrorMotherno &&   errorMessageMotherno}</p>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-row">
                <div class="mb-6">
                  ...
                  <input
                    ...
                    id="fathername"
                    name="fathername"
                    onChange={handleChange('fathername')} onBlur={validateFathername}
                    // value={fathername}
                  // onChange={handleInputChange}
                  //onBlur={validateOne}
                    ...
                    tabIndex="21"
                  />
                     <p className='error p-2'>{isErrorFathername &&   errorMessageFathername}</p>
                </div>
              </div>
              ...
              <div className="flex flex-row">
                <div class="mb-6">
                  ...
                  <input
                    ...
                    id="mothername"
                    name="mothername"
                    onChange={handleChange('mothername')} onBlur={validateMothername}
                    // value={mothername}
                  // onChange={handleInputChange}
                  //onBlur={validateOne}
                    className="hover:border-[2px] hover:border-[#159BD6] ml-[5px]  w-[350px] h-[40px] rounded-[5px] border border-[#CBCBCB] bg-[#FFFFFF] font-inter p-3 font-medium text-[16px] leading-[19.36px] tracking-[2%] focus:outline-none"
                   ...
                   // required
                    tabIndex="23"
                  />
                    <p className='error p-2'>{isErrorMothername &&  errorMessageMothername}</p>
                </div>
              </div>
