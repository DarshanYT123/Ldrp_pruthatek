...
className="text-sm  h-[55px] rounded-lg py-3 px-3 transition-all duration-300  "
          ...
          {/* <div className="py-4 w-[100%] bg-white ">
            <table className=" min-w-[100%] max-h-[250px] overflow-y-scroll overflow-hidden  border-collapse  ">
         
              <tr className="text-center ">
                <th className="border-r-[1px] px-[1.5rem] whitespace-nowrap  bg-[#159BD6] rounded-[5px_0px_0px_0px] border-[#47A5E4]  py-2 text-white text-[16px] font-Poppins not-italic font-semibold leading-[normal] tracking-[0.32px] capitalize">
                  <p>During</p>
                </th>
                <th className="border-r-[1px] px-[1.5rem] whitespace-nowrap  bg-[#159BD6] rounded-[5px_0px_0px_0px] border-[#47A5E4]  py-2 text-white text-[16px] font-Poppins not-italic font-semibold leading-[normal] tracking-[0.32px] capitalize">
                  <p>Activity</p>
...
className="text-sm  h-[55px] rounded-lg py-3 px-3 transition-all duration-300  "
              ...
              <tr className="text-sm  h-[55px] rounded-lg py-3 px-3 transition-all duration-300">
                <td className="px-[1rem]">
                  <div className=" p-3 table-auto1  py-2 border-[1px] border-[#47A5E4] bg-[#fff]    focus:outline-none">
                    {selectoption}
                  </div>
                </td>
                <td>
